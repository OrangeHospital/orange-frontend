...
export default function HeroSection({ data }: HeroSectionProps) {
  ...
  // Dynamic slides when custom page data is provided, otherwise fallback to static slides
  const slides =
    data?.image?.fileUrl || data?.title || data?.titleHighlight
      ? [
          {
            titlePrefix: data.titlePrefix || "",
            titleHighlight: data.titleHighlight || data.title || "",
            subtitle: data.subtitle || data.description || "",
            image: data.image?.fileUrl || "/hero_baby.png",
            primaryCta: {
      ...
      : [
          {
            ...
            subtitle: "Neonatal & Pediatric Intensive Care Unit",
            image: "/hero_baby.png",
            primaryCta: {
  ...
  return (
    <section
      className={`relative w-full overflow-hidden bg-slate-900 ${
        isSingleSlide
          ? "h-[45vh] md:h-[50vh] lg:h-[55vh] min-h-[300px] md:min-h-[380px]"
          : "h-[75vh] md:h-[80vh] lg:h-[85vh] min-h-[500px] md:min-h-[600px]"
      }`}
    >
