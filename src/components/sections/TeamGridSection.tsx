  ...
  const renderDoctorCard = (
    ...
    const photoContainer = (
      <div className="relative aspect-square w-full rounded-none overflow-visible mb-9 bg-slate-50 shadow-[0_4px_20px_rgba(0,0,0,0.02)] cursor-pointer">
        ...
        <div className="absolute -bottom-4 left-1/2 -translate-x-1/2 bg-white px-5 py-2.5 shadow-[0_8px_20px_rgba(0,0,0,0.05)] border border-slate-100/80 text-center w-[85%] sm:w-[80%] min-h-[46px] flex items-center justify-center transition-all duration-300 group-hover:shadow-[0_10px_25px_rgba(247,167,7,0.15)] group-hover:border-[#F7A707]/30">
          <span className="font-extrabold text-sm sm:text-[15px] text-[#2B6CB0] tracking-wide transition-colors duration-200 group-hover:text-[#F7A707] line-clamp-1">
            {member.name}
          </span>
        </div>
      </div>
